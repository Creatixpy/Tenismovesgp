        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            <div className="text-center py-8 sm:py-12">
              ...
              <p className="text-gray-500 mt-4 text-sm sm:text-base">Carregando produtos em destaque...</p>
            </div>
          ) : produtos.length === 0 ? (
            <div className="text-center py-8 sm:py-12">
              <p className="text-gray-500 text-base sm:text-lg">Nenhum produto em destaque encontrado.</p>
            </div>
          ) : (
                ...
                <div key={produto.id} className="group bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300 h-full flex flex-col">
                  <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 relative overflow-hidden flex-shrink-0">
                    ...
                    <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                      ...
                      >
                        <svg className="w-4 h-4 sm:w-5 sm:h-5" fill={isFavorito(produto.id) ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
